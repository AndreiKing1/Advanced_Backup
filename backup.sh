...
while true; do
    case "$1" in
        ...
        -u|--usage)
            ...
            echo "2. Mutare fisiere - userul va avea 2 optiuni, local sau cloud, daca este local va muta fisierele din directorul sursa in directorul specificat,"
            echo "   iar daca este in cloud, fisierele din path-ul respectiv vor fi salvate intr-un repository pe github"
            echo "3. Stergere fisiere - fisierele userului vor fi sterse daca acestea au fost create cu 60 de zile inainte."
            echo "4. Editare continut fisiere - scriptul adauga o linie de text \"##### DEPRECATED #####\" in fiecare fisier mai vechi de 7 zile."
            echo "5. Inchiriere Masini - userul introduce modelul masinii dorite pentru inchiriere, iar scriptul cauta in fisierele disponibile."
            echo "6. Vanzare Masini - userul introduce modelul masinii dorite pentru cumparare, iar scriptul cauta in fisierele disponibile."
            echo "7. Filtre de cautare - userul poate cauta masini dupa an, combustibil diesel sau combustibil benzina."
            echo "8. Exit - inchide aplicatia."
...
while true; do
    ...
    case $option in
        1)
            #Metoda aceasta calculeaza diferenta in zile dintre data curenta si data introdusa de user
        ...
        2)
            ...
            case $destination in
                "local")
                    # Metoda aceasta muta fisierele din directorul Firma vanzari cumparari intr-un director specificat de user
        ...
        4)
            ...
            for file in /home/$USER/Desktop/Firma_vanzare_cumparare_masini/* -type f -mtime +7; do
